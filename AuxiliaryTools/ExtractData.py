...
class Dataset(object):
    ...
    def __init__(self, max_length, path):
        ...
        self.userAuxReview_dict, self.userAuxMask_dict = self.load_reviews(max_length, len(self.word_id_dict), path + "UserAuxiliaryReviews.out")
    ...
    def load_reviews(self, max_doc_length, padding_word_id, path):
        ...
        with open(path, "r") as f:
            ...
            while line != None and line != "":
                ...
                mask_review_dict[entity] = mask
                line = f.readline().replace("\n", "")
        return entity_review_dict, mask_review_dict
